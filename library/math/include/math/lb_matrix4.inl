...
__forceinline lb_quaternion_t lb_matrix4_rotation(lb_matrix4_t a) {
  ...
  lb_vector3_t c0 = {a.m00, a.m10, a.m20};
  lb_vector3_t c1 = {a.m01, a.m11, a.m21};
  lb_vector3_t c2 = {a.m02, a.m12, a.m22};

  lb_vector3_t cn0 = lb_vector3_norm(c0);
  lb_vector3_t cn1 = lb_vector3_norm(c1);
  lb_vector3_t cn2 = lb_vector3_norm(c2);
...
__forceinline lb_vector3_t lb_matrix4_euler_angles(lb_matrix4_t a) {
  ...
  if (fabsf(a.m02) < (1.0F - LB_EPSILON_6)) {
    v.x = atan2f(-a.m12, a.m22);
    v.y = asinf(a.m02);
    v.z = atan2f(-a.m01, a.m00);
  } else {
    v.x = atan2f(a.m10, a.m11);
    v.y = (a.m02 > 0.0F) ? LB_PI_HALF : -LB_PI_HALF;
    v.z = 0.0F;
  }
...
__forceinline void lb_matrix4_decompose(lb_matrix4_t a, lb_vector3_t *p, lb_quaternion_t *r, lb_vector3_t *s) {
  ...
  s->x = lb_vector3_length(c0);
  s->y = lb_vector3_length(c1);
  s->z = lb_vector3_length(c2);
...
__forceinline lb_matrix4_t lb_matrix4_look_at(lb_vector3_t eye, lb_vector3_t center, lb_vector3_t up) {
  lb_vector3_t f = lb_vector3_norm(lb_vector3_sub(center, eye));
  lb_vector3_t r = lb_vector3_norm(lb_vector3_cross(f, up));
  lb_vector3_t u = lb_vector3_cross(r, f);
  ...
  lb_matrix4_t m = {
    ...
    f.z,
    0.0F,
    -lb_vector3_dot(r, eye),
    -lb_vector3_dot(u, eye),
    -lb_vector3_dot(f, eye),
    1.0F,
  };
