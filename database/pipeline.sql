CREATE TABLE IF NOT EXISTS PIPELINE_ASSETS (
	...
	AUTO_CREATE_PIPELINE            INTEGER NOT NULL,
	AUTO_CREATE_VERTEX_INPUT_BUFFER INTEGER NOT NULL,
	AUTO_LINK_DESCRIPTOR_BINDINGS   INTEGER NOT NULL,
	INTERLEAVED_VERTEX_INPUT_BUFFER INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS PIPELINE_RESOURCES (
	ID                        INTEGER PRIMARY KEY AUTOINCREMENT,
	PIPELINE_ASSET_ID         INTEGER NOT NULL,
	VERTEX_SHADER_FILE_PATH   TEXT,
	FRAGMENT_SHADER_FILE_PATH TEXT,
	COMPUTE_SHADER_FILE_PATH  TEXT,
	CREATED_AT                DATETIME DEFAULT CURRENT_TIMESTAMP,
	FOREIGN KEY               (PIPELINE_ASSET_ID) REFERENCES PIPELINE_ASSETS(ID)
	UNIQUE                    (PIPELINE_ASSET_ID)
);
...
CREATE TABLE IF NOT EXISTS PIPELINE_VERTEX_INPUT_BINDINGS (
	...
	CREATED_AT        DATETIME DEFAULT CURRENT_TIMESTAMP,
	FOREIGN KEY       (PIPELINE_ASSET_ID) REFERENCES PIPELINE_ASSETS(ID),
	UNIQUE            (PIPELINE_ASSET_ID, LOCATION)
);
...
CREATE TABLE IF NOT EXISTS PIPELINE_DESCRIPTOR_BINDINGS (
	...
	CREATED_AT        DATETIME DEFAULT CURRENT_TIMESTAMP,
	FOREIGN KEY       (PIPELINE_ASSET_ID) REFERENCES PIPELINE_ASSETS(ID),
	UNIQUE            (PIPELINE_ASSET_ID, BINDING)
);