...
static void player_handle_position(player_t *player) {
  ...
  if (context_is_keyboard_key_held(KEYBOARD_KEY_D)) {
    ...
    right_direction = vector3_muls(right_direction, (float)g_context_delta_time);
  ...
  if (context_is_keyboard_key_held(KEYBOARD_KEY_A)) {
    ...
    left_direction = vector3_muls(left_direction, (float)g_context_delta_time);
  ...
  if (context_is_keyboard_key_held(KEYBOARD_KEY_E)) {
    ...
    up_direction = vector3_muls(up_direction, (float)g_context_delta_time);
  ...
  if (context_is_keyboard_key_held(KEYBOARD_KEY_Q)) {
    ...
    down_direction = vector3_muls(down_direction, (float)g_context_delta_time);
  ...
  if (context_is_keyboard_key_held(KEYBOARD_KEY_W)) {
    ...
    front_direction = vector3_muls(front_direction, (float)g_context_delta_time);
  ...
  if (context_is_keyboard_key_held(KEYBOARD_KEY_S)) {
    ...
    back_direction = vector3_muls(back_direction, (float)g_context_delta_time);
...
static void player_handle_rotation(player_t *player) {
  if (context_is_mouse_key_pressed(MOUSE_KEY_RIGHT)) {
    player->mouse_begin = vector3_xyz((float)g_context_mouse_position_x, (float)g_context_mouse_position_y, 0.0F);
    ...
    player->mouse_end = vector3_xyz((float)g_context_mouse_position_x, (float)g_context_mouse_position_y, 0.0F);
  ...
  mouse_damping = vector3_muls(mouse_damping, (float)g_context_delta_time);
