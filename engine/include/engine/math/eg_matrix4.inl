...
__forceinline eg_quaternion_t eg_matrix4_rotation(eg_matrix4_t a) {
  ...
  eg_vector3_t c0 = {a.m00, a.m10, a.m20};
  eg_vector3_t c1 = {a.m01, a.m11, a.m21};
  eg_vector3_t c2 = {a.m02, a.m12, a.m22};

  eg_vector3_t cn0 = eg_vector3_norm(c0);
  eg_vector3_t cn1 = eg_vector3_norm(c1);
  eg_vector3_t cn2 = eg_vector3_norm(c2);
...
__forceinline eg_vector3_t eg_matrix4_euler_angles(eg_matrix4_t a) {
  ...
  if (fabsf(a.m02) < (1.0F - EG_EPSILON_6)) {
    v.x = atan2f(-a.m12, a.m22);
    v.y = asinf(a.m02);
    v.z = atan2f(-a.m01, a.m00);
  } else {
    v.x = atan2f(a.m10, a.m11);
    v.y = (a.m02 > 0.0F) ? EG_PI_HALF : -EG_PI_HALF;
    v.z = 0.0F;
  }
...
__forceinline void eg_matrix4_decompose(eg_matrix4_t a, eg_vector3_t *p, eg_quaternion_t *r, eg_vector3_t *s) {
  ...
  s->x = eg_vector3_length(c0);
  s->y = eg_vector3_length(c1);
  s->z = eg_vector3_length(c2);
...
__forceinline eg_matrix4_t eg_matrix4_look_at(eg_vector3_t eye, eg_vector3_t center, eg_vector3_t up) {
  eg_vector3_t f = eg_vector3_norm(eg_vector3_sub(center, eye));
  eg_vector3_t r = eg_vector3_norm(eg_vector3_cross(f, up));
  eg_vector3_t u = eg_vector3_cross(r, f);
  ...
  eg_matrix4_t m = {
    ...
    f.z,
    0.0F,
    -eg_vector3_dot(r, eye),
    -eg_vector3_dot(u, eye),
    -eg_vector3_dot(f, eye),
    1.0F,
  };
